...
inline const char *EnumNameImageType(ImageType e) {
  if (::flatbuffers::IsOutRange(e, ImageType::NONE, ImageType::NV12Image)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesImageType()[index];
}

template<typename T> struct ImageTypeTraits {
  static const ImageType enum_value = ImageType::NONE;
};

template<> struct ImageTypeTraits<hyperionnet::RawImage> {
  static const ImageType enum_value = ImageType::RawImage;
};

template<> struct ImageTypeTraits<hyperionnet::NV12Image> {
  static const ImageType enum_value = ImageType::NV12Image;
};

bool VerifyImageType(::flatbuffers::Verifier &verifier, const void *obj, ImageType type);
bool VerifyImageTypeVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<ImageType> *types);
...
inline const char *EnumNameCommand(Command e) {
  if (::flatbuffers::IsOutRange(e, Command::NONE, Command::Register)) return "";
  const size_t index = static_cast<size_t>(e);
...
struct Image FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const hyperionnet::RawImage *data_as_RawImage() const {
    return data_type() == hyperionnet::ImageType::RawImage ? static_cast<const hyperionnet::RawImage *>(data()) : nullptr;
  }
  const hyperionnet::NV12Image *data_as_NV12Image() const {
    return data_type() == hyperionnet::ImageType::NV12Image ? static_cast<const hyperionnet::NV12Image *>(data()) : nullptr;
  }
...
inline bool VerifyImageTypeVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<ImageType> *types) {
